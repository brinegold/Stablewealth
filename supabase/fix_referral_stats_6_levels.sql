-- Update get_referral_stats_optimized to support 6 levels and correct rates
...
BEGIN
    ...
    CROSS JOIN (
        -- Level statistics for all 6 levels
        SELECT json_agg(
            json_build_object(
...
SELECT 'Referral stats function updated for 6 levels!' as status;
